          ...
          >
            <Box>
              <Avatar
                ...
                alt="Remy Sharp"
                src={user.celebrityscore[0].pic}
                className={classes.avatar}
              />
              <Typography variant="subtitle1" className={classes.scores}>
                {user.celebrityscore[0].score}
              </Typography>
            </Box>
          </Tooltip>
        </ClickAwayListener>
          ...
          >
            <Box>
              <Avatar
                ...
                alt="Remy Sharp"
                src={user.celebrityscore[1].pic}
                className={classes.middleAvatar}
              />
              <Typography variant="subtitle1" className={classes.scores}>
                {user.celebrityscore[1].score}
              </Typography>
            </Box>
          </Tooltip>
        </ClickAwayListener>
          ...
          >
            <Box>
              <Avatar
                ...
                alt="Remy Sharp"
                src={user.celebrityscore[2].pic}
                className={classes.avatar}
              />
              <Typography variant="subtitle1" className={classes.scores}>
                {user.celebrityscore[2].score}
              </Typography>
            </Box>
          </Tooltip>
        </ClickAwayListener>
